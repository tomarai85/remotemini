#!/bin/bash
# controls-for: ios/Sources/Core/SessionsListingFixture.swift ios/Sources/Core/HistoryFixture.swift ios/Sources/Core/KeyEntryProbeFixture.swift ios/Sources/Core/SignOutNoticeFixture.swift ios/Sources/Core/ProvisioningFixture.swift ios/project.yml
#
