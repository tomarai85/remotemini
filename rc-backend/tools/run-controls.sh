...
LOCAL_CTLS=(
    ...
    ../ios/tools/signout-notice-control.sh # ★2026-08-08(#37 / 監査 X2-6、#40 / 監査 X2-8)、
                                     ...
                                     #   FirstRunUITests)。錨21本のうち FirstRun 側の1本は
                                     ...
                                     #   踏んだ、写しが2つ在る型)。
                                     # 実測 2026-08-11: xcodebuild 20回(基準 + 変異19、
                                     # うち6回は UI class 込み)で **real 700.5 秒**
                                     # (= 11分40秒、DerivedData が温まっている時。
                                     # PASS 20 / FAIL 0 / UNMEASURED 0)。
                                     # M18/M19 は単体だけで赤くなるので UI 回数は増えない
                                     # (足した2本の値段は 24 秒)。
