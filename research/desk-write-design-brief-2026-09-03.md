...
**Tom の回答(2026-09-03 午後)**: #11 = **はい**(roots の下だけ。実装開始、spec = `.harness/spec-2026-09-03-roots-new-session.md`)/ #15 = **いいえ**(4 枚目にしない → 案 2「打った時だけ 2 段目」で実装)/ #8・#32 = 此の回の質問に入れていない。推奨どおり現状維持(Escape は全部止める / 通知トグルは作らない)で進め、Tom が変えたい日に言う。
